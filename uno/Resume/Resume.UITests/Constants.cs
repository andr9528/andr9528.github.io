namespace Resume.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.companyname.Resume";
    public readonly static string AndroidAppName = "com.companyname.Resume";
